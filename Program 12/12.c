...
#define MAXPRODLEN 10//Max length of a single production
#define MAX 50// Max size of input string and stack

//Specify productions here
...
short top=-1,ip_ptr=0;//pointer to the top of the stack and input string
//Prototypes of shift and reduce
